...
folder2223_path = '/Users/as/Library/CloudStorage/GoogleDrive-exyhd1@gmail.com/My Drive/Dorking Wanderers FC Scouting/Recruitment/Pipeline/2223'
folder2324_path = '/Users/as/Library/CloudStorage/GoogleDrive-exyhd1@gmail.com/My Drive/Dorking Wanderers FC Scouting/Recruitment/Pipeline/2324'
...
def process_data_sets():
    ...
    global df
    df = pd.concat([df_2223, df_2324], ignore_index=True)
...
def possession_adjust_def():
    possession_adjust_def = df['Interceptions per 90'] / df['PAdj Interceptions']
